...
var SPEC = {
    ...
    hypeLauncherV2Size: { def: "compact" },
    hypeLauncherV2BorderEnabled: { def: false },
    hypeLauncherV2BorderThickness: { def: 2 },
    hypeLauncherV2BorderColor: { def: "primary" },
    hypeLauncherV2ShowFooter: { def: true },
    hypeLauncherV2UnloadOnClose: { def: false },
    hypeLauncherV2IncludeFilesInAll: { def: false },
    hypeLauncherV2IncludeFoldersInAll: { def: false },
